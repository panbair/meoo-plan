...
.mga-page { font-family: system-ui, sans-serif; background: #060610; color: #fff; }
...
.mga-num { font-size: clamp(3rem, 8vw, 6rem); font-weight: 900; color: rgba(255,255,255,0.06); user-select: none; pointer-events: none; }
</style>
...
.mga-dot {
  ...
  &.mga-active { background: $accent; border-color: rgba(255,255,255,0.35); transform: scale(1.5); box-shadow: 0 0 14px rgba($accent, 0.5); }
}
.mga-indicator {
