...
.ls-page { font-family: 'Noto Sans SC', -apple-system, sans-serif; background: #f5f0f8; color: #1a1a2e; }
...
.ls-nav-dot { width: 12px; height: 12px; border-radius: 50%; background: rgba(0,200,255,.2); cursor: pointer; border: 2px solid transparent; transition: all .3s;
  ...
  &.ls-active { background: #f5f0f8; border-color: rgba(0,200,255,.4); transform: scale(1.4); box-shadow: 0 0 20px rgba(0,200,255,.6); }
}
