...
.orw-num {
  ...
  color: rgba(26, 26, 46, 0.08); user-select: none; pointer-events: none;
}
...
.orw-dot {
  ...
  &.orw-active { background: $accent; border-color: rgba(26, 26, 46, 0.35); transform: scale(1.5); box-shadow: 0 0 14px rgba($accent, 0.5); }
}
.orw-indicator {
