...
.tfi-page { font-family: 'Noto Sans SC', -apple-system, BlinkMacSystemFont, sans-serif; background: #f5f0f8; color: #1a1a2e; }
...
.tfi-panel-0 { background: linear-gradient(135deg, #dcdff0, #16213e); }
.tfi-panel-1 { background: linear-gradient(135deg, #d0ddf0, #533483); }
.tfi-panel-2 { background: linear-gradient(135deg, #e94560, #d0ddf0); }
.tfi-panel-3 { background: linear-gradient(135deg, #16213e, #e94560); }
.tfi-panel-4 { background: linear-gradient(135deg, #533483, #dcdff0); }
.tfi-panel-5 { background: linear-gradient(135deg, #1a1a40, #d0ddf0); }
.tfi-panel-6 { background: linear-gradient(135deg, #d0ddf0, #dcdff0); }
...
.tfi-nav-dot {
  ...
  &.tfi-active { background: #6c8cff; border-color: rgba(26, 26, 46,.4); transform: scale(1.4); box-shadow: 0 0 20px rgba(108,140,255,.5); }
}
.tfi-progress-bar { position: fixed; top: 0; left: 0; height: 3px; z-index: 1001; width: 0%; background: linear-gradient(90deg, #e94560, #533483, #d0ddf0, #6c8cff); box-shadow: 0 0 10px rgba(108,140,255,.4); }
.tfi-page-indicator { position: fixed; top: 30px; right: 30px; z-index: 1000; background: rgba(255, 255, 255, 0.75); backdrop-filter: blur(12px); padding: 8px 22px; border-radius: 25px; font-size: .9rem; border: 1px solid rgba(255,255,255,.1); color: rgba(26, 26, 46,.8); }
