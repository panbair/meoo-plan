...
.tsp-page { font-family: 'Noto Sans SC', -apple-system, BlinkMacSystemFont, sans-serif; background: #0a0a0f; color: #fff; }
...
.tsp-panel-0 { background: linear-gradient(135deg, #1a1a2e, #16213e); }
.tsp-panel-1 { background: linear-gradient(135deg, #0f3460, #533483); }
.tsp-panel-2 { background: linear-gradient(135deg, #e94560, #0f3460); }
.tsp-panel-3 { background: linear-gradient(135deg, #16213e, #e94560); }
.tsp-panel-4 { background: linear-gradient(135deg, #533483, #1a1a2e); }
.tsp-panel-5 { background: linear-gradient(135deg, #1a1a40, #0f3460); }
.tsp-panel-6 { background: linear-gradient(135deg, #0f3460, #1a1a2e); }
...
.tsp-nav-dot {
  ...
  &.tsp-active { background: #6c8cff; border-color: rgba(255,255,255,.4); transform: scale(1.4); box-shadow: 0 0 20px rgba(108,140,255,.5); }
}
.tsp-progress-bar { position: fixed; top: 0; left: 0; height: 3px; z-index: 1001; width: 0%; background: linear-gradient(90deg, #e94560, #533483, #0f3460, #6c8cff); box-shadow: 0 0 10px rgba(108,140,255,.4); }
.tsp-page-indicator { position: fixed; top: 30px; right: 30px; z-index: 1000; background: rgba(0,0,0,.4); backdrop-filter: blur(12px); padding: 8px 22px; border-radius: 25px; font-size: .9rem; border: 1px solid rgba(255,255,255,.1); color: rgba(255,255,255,.8); }
