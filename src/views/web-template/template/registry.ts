...
const LABEL_MAP: Record<string, string> = {
  ...
  'scroll-multi-direction': '多方向入场',
  'scroll-split-merge': '劈合入场',
  'scroll-diagonal-slide': '对角线滑入',
  'scroll-iris-open': '光圈打开',
  'scroll-quad-corner': '四角汇聚',
  'scroll-door-open': '双开门',
  'scroll-blinds-reveal': '百叶窗',
  'scroll-spiral-in': '螺旋飞入',
  'scroll-shutter-split': '快门四裂',
  'scroll-loop-conveyor': '无限循环传送带',
  'scroll-alternate-slide': '交替滑入',
  'scroll-parallax-layers': '层叠视差',
  'scroll-parallax-split': '视差劈屏',
  'scroll-parallax-depth': '纵深视差',
  ...
  'scroll-film-reel': '胶片卷轴',
  'scroll-sand-hourglass': '沙漏'
}
