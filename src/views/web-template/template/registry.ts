...
const LABEL_MAP: Record<string, string> = {
  ...
  'scroll-liquid-metal-morph': '液态金属变形',
  ...
  'scroll-magnetic-shuffle': '磁力洗牌',
  'scroll-masonry-expand': '瀑布展开',
  ...
  'scroll-carousel-snap': '轮播吸附',
  'scroll-carousel-vortex': '轮播漩涡',
  'scroll-chess-flip': '棋盘翻转',
  'scroll-clock-wipe': '时钟擦除',
  'scroll-contrast-glitch': '对比故障',
  'scroll-conveyor-belt': '传送带滚动',
  'scroll-crossfade-stack': '交叉叠化',
  'scroll-curtain-explode': '帷幕爆炸',
  'scroll-curtain-peel': '帷幕剥离',
  'scroll-counter-vortex': '计数漩涡',
  'scroll-diamond-shatter': '钻石碎裂',
  'scroll-echo-dissolve': '回音溶解',
  'scroll-elastic-expand': '弹力展开',
  'scroll-elastic-snap': '弹性吸附',
  ...
  'scroll-fire-water-clash': '火水交锋',
  'scroll-glass-parallax': '毛玻璃视差',
  ...
  'scroll-stack-glitch': '堆叠故障',
  'scroll-stagger-vortex': '交错漩涡',
  'scroll-snake-path': '蛇形路径',
  'scroll-split-parallax': '分屏视差',
  'scroll-spiral-implode': '螺旋内爆',
  'scroll-spiral-in': '螺旋卷入',
  'scroll-split-merge': '分裂合并',
  'scroll-telescope-zoom': '望远镜变焦',
  'scroll-timeline-split': '时间线分屏',
  'scroll-typewriter': '打字机效果',
  'scroll-typewriter-glitch': '打字机故障',
  'scroll-u-turn': 'U型转弯',
  'scroll-v-h-v': '纵横纵',
  'scroll-v-then-h': '先纵后横',
  'scroll-vortex-whirl': '漩涡吸入',
  'scroll-warp-fade': '扭曲淡出',
  'scroll-zigzag-drift': '之字漂移',
  'scroll-zigzag-elastic': '之字弹跳',
  'scroll-zigzag-masonry': '之字瀑布',
