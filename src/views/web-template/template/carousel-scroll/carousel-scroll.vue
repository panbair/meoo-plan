...
.carousel-slide-0 { background: radial-gradient(ellipse 70% 50% at 40% 30%, rgba(99,102,241,0.1), transparent 70%), linear-gradient(135deg, #07081c, #0e1240, #14164a); }
.carousel-slide-1 { background: radial-gradient(ellipse 60% 50% at 70% 40%, rgba(6,182,212,0.08), transparent 65%), linear-gradient(135deg, #071820, #0e3040, #164e5c); }
.carousel-slide-2 { background: radial-gradient(ellipse 50% 60% at 30% 60%, rgba(139,92,246,0.07), transparent 65%), linear-gradient(135deg, #0a1025, #162450, #1a2d5c); }
.carousel-slide-3 { background: radial-gradient(ellipse 60% 50% at 50% 30%, rgba(59,130,246,0.08), transparent 65%), linear-gradient(135deg, #0c0c22, #0e2850, #0a1840); }
.carousel-slide-4 { background: radial-gradient(ellipse 60% 50% at 50% 40%, rgba(99,102,241,0.08), transparent 70%), linear-gradient(135deg, #080e28, #121e48, #0e1838); }
