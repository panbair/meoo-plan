...
.ts-page { font-family: 'Noto Sans SC', -apple-system, BlinkMacSystemFont, sans-serif; background: #f5f0f8; color: #1a1a2e; }
...
.ts-panel-0 { background: linear-gradient(135deg, #e8ebf5, #d8daf0); }
.ts-panel-1 { background: linear-gradient(135deg, #e8f0f4, #d0e4ec); }
.ts-panel-2 { background: linear-gradient(135deg, #e8ecf2, #d4e0ec); }
.ts-panel-3 { background: linear-gradient(135deg, #dcdff0, #d0ddf0); }
.ts-panel-4 { background: linear-gradient(135deg, #ececf2, #dcdcf0); }
.ts-panel-5 { background: linear-gradient(135deg, #d0d8f0, #d0f5f4); }
.ts-panel-6 { background: linear-gradient(135deg, #e4e8f5, #d8dff0); }
...
.ts-nav-dot {
  ...
  &.ts-active { background: #6c8cff; border-color: rgba(26, 26, 46,.4); transform: scale(1.4); box-shadow: 0 0 20px rgba(108,140,255,.5); }
}
...
.ts-page-indicator { position: fixed; top: 30px; right: 30px; z-index: 1000; background: rgba(255, 255, 255, 0.75); backdrop-filter: blur(12px); padding: 8px 22px; border-radius: 25px; font-size: .9rem; border: 1px solid rgba(255,255,255,.1); color: rgba(26, 26, 46,.8); }
