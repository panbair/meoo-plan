...
.tst-page { font-family: 'Noto Sans SC', -apple-system, BlinkMacSystemFont, sans-serif; background: #0a0a0f; color: #fff; }
...
.tst-panel-0 { background: linear-gradient(135deg, #0a0f24, #1a1a5e); }
.tst-panel-1 { background: linear-gradient(135deg, #0f2027, #2c5364); }
.tst-panel-2 { background: linear-gradient(135deg, #141e30, #243b55); }
.tst-panel-3 { background: linear-gradient(135deg, #1a1a2e, #0f3460); }
.tst-panel-4 { background: linear-gradient(135deg, #0d0d1a, #1a1a3e); }
.tst-panel-5 { background: linear-gradient(135deg, #1a2980, #26d0ce); }
.tst-panel-6 { background: linear-gradient(135deg, #0b1331, #1c2856); }
...
.tst-nav-dot {
  ...
  &.tst-active { background: #6c8cff; border-color: rgba(255,255,255,.4); transform: scale(1.4); box-shadow: 0 0 20px rgba(108,140,255,.5); }
}
.tst-progress-bar { position: fixed; top: 0; left: 0; height: 3px; z-index: 1001; width: 0%; background: linear-gradient(90deg, #6c8cff, #a78bfa, #f472b6, #26d0ce); box-shadow: 0 0 10px rgba(108,140,255,.4); }
.tst-page-indicator { position: fixed; top: 30px; right: 30px; z-index: 1000; background: rgba(0,0,0,.4); backdrop-filter: blur(12px); padding: 8px 22px; border-radius: 25px; font-size: .9rem; border: 1px solid rgba(255,255,255,.1); color: rgba(255,255,255,.8); }
