...
export const homePageComponentsList = [
  'CardImage3DAdaptive',
  'CardImage3DAlbum',
  'CardImage3DAlgorithmic',
  'CardImage3DAnchor',
  'CardImage3DAtmos',
  'CardImage3DBlindsReveal',
  'CardImage3DBookOpen',
  'CardImage3DBridge',
  'CardImage3DCardHouse',
  'CardImage3DCarousel',
  'CardImage3DCascadeWall',
  'CardImage3DCheckerFlip',
  'CardImage3DChineseLantern',
  'CardImage3DCineHolo',
  'CardImage3DCompassClock',
  'CardImage3DCone',
  'CardImage3DConstellationOrbit',
  'CardImage3DCrystalGrowth',
  'CardImage3DCube',
  'CardImage3DCurtainReveal',
  'CardImage3DCylinder',
  'CardImage3DDNAHelixTunnel',
  'CardImage3DDeckShuffle',
  ...
  'CardImage3DDiamond',
  'CardImage3DDimensionalRift',
  'CardImage3DDominoCascade',
  'CardImage3DDominoChain',
  'CardImage3DDoomLike',
  'CardImage3DEscherStairs',
  'CardImage3DExplodedView',
  'CardImage3DFan',
  'CardImage3DFireworks',
  'CardImage3DFlipBook',
  'CardImage3DFloatingIslands',
  'CardImage3DFoldPaper',
  'CardImage3DFoldSpace',
  'CardImage3DFoldingFan',
  'CardImage3DFragmentReconstruct',
  'CardImage3DGalleryArc',
  'CardImage3DGalleryFloor',
  'CardImage3DGyroscope',
  'CardImage3DHelix',
  'CardImage3DHoloRealm',
  'CardImage3DHoneycombTunnel',
  'CardImage3DHourglass',
  'CardImage3DInertiaRibbon',
  'CardImage3DInfinitum',
  'CardImage3DInfinityMirror',
  'CardImage3DInfinityTunnel',
  'CardImage3DInteractive',
  'CardImage3DJigsawPuzzle',
  'CardImage3DKaleidoShatter',
  'CardImage3DKaleidoscopeTunnel',
  'CardImage3DLayeredRealm',
  'CardImage3DLayeredView',
  'CardImage3DLightFlow',
  'CardImage3DLookAt',
  'CardImage3DMacroLens',
  'CardImage3DMagicCube',
  'CardImage3DMagneticField',
  'CardImage3DMask',
  'CardImage3DMasonry',
  'CardImage3DMetalForge',
  'CardImage3DMirrorFloor',
  'CardImage3DMirrorRealm',
  'CardImage3DMobius',
  'CardImage3DMobiusGallery',
  'CardImage3DNestedRhythm',
  'CardImage3DNestedSpheres',
  'CardImage3DNormalMap',
  'CardImage3DOrbit',
  'CardImage3DPanelFold',
  'CardImage3DPanoramaRing',
  'CardImage3DPapercutTheater',
  'CardImage3DParametric',
  'CardImage3DPerfRing',
  'CardImage3DPlanetOrbit',
  'CardImage3DPopupBook',
  'CardImage3DPortalPair',
  'CardImage3DPrism',
  'CardImage3DProcedural',
  'CardImage3DPropGradient',
  'CardImage3DPyramid',
  'CardImage3DRecursiveRoom',
  'CardImage3DReliefGallery',
  'CardImage3DRibbon',
  'CardImage3DRipplePond',
  'CardImage3DRoom',
  'CardImage3DShapeAirplane',
  'CardImage3DShapeButterfly',
  'CardImage3DShapeKite',
  'CardImage3DShatterRebuild',
  'CardImage3DSphere',
  'CardImage3DSpiral',
  'CardImage3DSpiralStaircase',
  'CardImage3DSpiralWave',
  'CardImage3DSpotlightSweep',
  'CardImage3DSpringCoil',
  'CardImage3DStage',
  'CardImage3DStereoFlux',
  'CardImage3DSymmetryHall',
  'CardImage3DTactile',
  'CardImage3DTesseract',
  'CardImage3DTorus',
  'CardImage3DTunnel',
  'CardImage3DUpsideDown',
  'CardImage3DVortex',
  'CardImage3DVortexSwirl',
  'CardImage3DVoxelTerrain',
  'CardImage3DWaterSurface',
  'CardImage3DWaveGrid',
  'CardImage3DWaveWall',
  'CardImage3DWindChime',
  'CardImage3DWormhole',
  'CardImageAnaglyph3D'
]
...
export const componentsList = [
  ...
  'CardVideoPrismRefract',
  'CardVideoScrubFlow',
  'CardVideoSplitScreen',
  'CardVideoSpotlight',
  'CardImage3DAdaptive',
  'CardImage3DDoomLike',
  'CardImage3DParametric',
  ...
  'CardImage3DPanelFold',
  'CardImage3DStage',
  'CardImageParallaxFlow',
  'CardImageBloomRise',
  'CardImageDirectionalFlow',
  'CardImageFloatBounce',
  'CardImageGrandGallery',
  'CardImagePhyllotaxisGarden',
  'CardImagePulseWave',
  'CardImageSpinFlow',
  'CardImageStrangeAttractor',
  'CardImageSwayDance',
  'CardImageThousandHands',
  'CardImageVoronoiShatter',
  'CardImageWiggleShake',
 ...
 */
export const buildCopyContentStr = (
  selectedComponents,
  modulePositions,
  enterpriseInfo,
  selectedTemplateKey,
