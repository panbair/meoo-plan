<template>
  <div class="web-list">
    ...
    >
      <!-- 懒加载：只在进入视口时渲染组件 -->
      <component
          v-if="visibleCards.has(index)"
          :is="cardInfo.component"
          v-bind="propsMap[index]"
      />
      <span class="position-absolute top-10px left-100px color-red z-index-99999"> {{cardInfo.dirName}}</span>
    </div>
 ...
 * 自动化构建组件列表
 */
// let dirNameList=['CardAuroraWave', 'CardCatalyst', 'CardGravity', 'CardGravity2','CardBioluminescence', 'CardCelestial', 'CardCircuit', 'CardCyberspace',  'CardEclipse', 'CardFrost', 'CardFusion', 'CardGlacier', 'CardHolographic', 'CardLightning', 'CardMagma', 'CardNebula', 'CardPhantom', 'CardPlasma', 'CardPrism', 'CardRipple', 'CardSupernova', 'CardSwipe', 'CardTornado', 'CardVoid','CardAllInOne', 'CardAudioWave', 'CardAurora', 'CardCrystal', 'CardDNA', 'CardDataStream', 'CardFadeBlur', 'CardFadeInOut', 'CardFireflies', 'CardFullCombo', 'CardGalaxy', 'CardGlitch', 'CardGradientWave', /*'CardGravity',*/ 'CardHologram', 'CardInfinity', 'CardKaleidoscope', 'CardLiquid', 'CardLiquidMetal', 'CardMatrix', 'CardMeteor', 'CardMorph', 'CardMosaic', 'CardNeon', 'CardNeonCircuit', 'CardNineCombo', 'CardParticle', 'CardPortal', 'CardQuantum', 'CardRotate', 'CardRotateScaleTranslate', 'CardScale', 'CardShatter', 'CardSixCombo', 'CardSlideEdge', 'CardSolarSystem', 'CardSphere', 'CardTranslate', 'CardTranslateRotateScale', 'CardVortex', 'CardWave']
let dirNameList1=[]
let dirNameList=[]
